  ...
  ariaControl.Menu.prototype =
  {
      ...
      _doInit : function()
      {
        ...
        if ( !this._link )
        {
          ...
          Event.observe( this._link, 'keyup', this.onKeyUpLink.bindAsEventListener(this));
      ...
      onClickLink : function( event )
      {
        ...
        page.aria.toggle(this._popup, this._link);
      ...
      close : function()
      {
        ...
        {
          this._link.focus();
          page.aria.hide(this._popup, this._link);
        }
      },
      ...
      onKeyUpLink : function (event)
      {
        // If the keyboard is used to select an item from the dropdown, the selection will be made and the dropdown will
        // close, but a keyup event will be sent to the link. Usually this is no problem, but in a FF-only corner case,
        // if the link is a <button> and the key is SPACE, the keyup will be interpreted as a click and the dropdown
        // will reopen unexpectedly. This line prevents the corner case.
